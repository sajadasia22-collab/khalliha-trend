...
- تحسينات المجتمع الاحترافية: أربع صور للمنشور، رابط منفرد، ردود التعليقات، معاينة روابط آمنة، متابعة مباشرة، وتحميل تلقائي.
- تفعيل `ERROR_ALERT_WEBHOOK_URL` يدوياً في Vercel للتنبيه الخارجي.

## المرحلة التالية

تشغيل الإصدار v4 ومراقبته، ثم ترتيب التكاملات الرسمية للدفع والسوشال بعد توفير Credentials وSandbox وموافقة صريحة.
