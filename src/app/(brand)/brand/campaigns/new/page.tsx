  ...
  return (
    <main className="min-h-screen bg-[var(--color-bg)] text-[var(--color-text)] dir-rtl md:ps-64 pb-20 md:pb-0">
      ...
      <section className="mx-auto max-w-4xl px-5 py-12 lg:px-8">
        <h1 className="mb-2 text-3xl font-extrabold">إنشاء حملة جديدة</h1>
        <p className="mb-8 text-sm font-medium text-[var(--color-text-secondary)]">
          تُحفظ الحملة كمسودة أولاً، ويمكنك تعديلها قبل إرسالها لمراجعة الإدارة.
        </p>
