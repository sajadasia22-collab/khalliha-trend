...
2. التكاملات الحقيقية للدفع والسوشال تحتاج حسابات مزودين وCredentials وSandbox وموافقة منفصلة.

> أُزيل زر رفع ملفات الحملة التجريبي في 2026-07-15 لأنه لم يكن مربوطاً بتخزين حقيقي؛ الواجهة تعرض فقط روابط Drive/Dropbox/OneDrive المدعومة فعلياً ولا تدّعي نجاح رفع غير منفّذ.
