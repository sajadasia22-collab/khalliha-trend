...
**كل المراحل 0–14 مكتملة، والإصدار v4 قيد النشر إلى الإنتاج** (`khalliha-trend.vercel.app`). آخر ما أُنجز:
...
2. التحقق من إصدار v4 على Vercel بعد تطبيق migration المراسلة تلقائياً.
